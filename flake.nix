    ...
    let
      ...
      mkGoUnifiMcp = pkgs:
        ...
        pkgs.buildGoModule {
          ...
          vendorHash = "sha256-kCQpJQMMMSlQkMYzVNmypdLJfl0S0dRn+I+RbnW6lao=";
          goSum = ./go.sum;
